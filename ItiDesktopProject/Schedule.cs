...
namespace Clicic
{
    public partial class Schedule : Form
    {
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            prescriptionAndDiagnosis.visit = context.Visites.Include("Clinc").Where(p => p.Patient.name == cellValue).Select(p => p).FirstOrDefault();
            //prescriptionAndDiagnosis.visit = context.Visites.Where(p => p.Patient.name == cellValue).Select(p => p).FirstOrDefault();
            prescriptionAndDiagnosis.LoggedUser = this.LoggedUser;
            prescriptionAndDiagnosis.Show();
            this.Hide();
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            //servicesBill.visit = 
            servicesBill.LoggedUser = this.LoggedUser;
            servicesBill.Show();
